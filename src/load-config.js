...
const finalConfig = {
    ...
    https: process.env.ACTUAL_HTTPS_KEY && process.env.ACTUAL_HTTPS_CERT
        ? {
        ...
        : config.https,
    upload: process.env.ACTUAL_UPLOAD_FILE_SYNC_SIZE_LIMIT_MB ||
        process.env.ACTUAL_UPLOAD_SYNC_ENCRYPTED_FILE_SYNC_SIZE_LIMIT_MB ||
        process.env.ACTUAL_UPLOAD_FILE_SIZE_LIMIT_MB
        ? {
            fileSizeSyncLimitMB: +process.env.ACTUAL_UPLOAD_FILE_SYNC_SIZE_LIMIT_MB ||
                +process.env.ACTUAL_UPLOAD_FILE_SIZE_LIMIT_MB ||
                config.upload.fileSizeSyncLimitMB,
            syncEncryptedFileSizeLimitMB: +process.env.ACTUAL_UPLOAD_SYNC_ENCRYPTED_FILE_SYNC_SIZE_LIMIT_MB ||
                +process.env.ACTUAL_UPLOAD_FILE_SIZE_LIMIT_MB ||
                config.upload.syncEncryptedFileSizeLimitMB,
            fileSizeLimitMB: +process.env.ACTUAL_UPLOAD_FILE_SIZE_LIMIT_MB ||
...
if (finalConfig.upload) {
    ...
    debug(`using sync encrypted file limit ${finalConfig.upload.syncEncryptedFileSizeLimitMB}mb`);
