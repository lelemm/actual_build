...
describe('Abanca', () => {
    describe('#normalizeTransaction', () => {
        it('returns the creditorName and debtorName as remittanceInformationStructured', () => {
            ...
            expect(normalizedTransaction.creditorName).toEqual(transaction.remittanceInformationStructured);
            expect(normalizedTransaction.debtorName).toEqual(transaction.remittanceInformationStructured);
        });
    });
});
