...
describe('Virgin', () => {
    describe('#normalizeTransaction', () => {
        it('does not alter simple payee information', () => {
            ...
            expect(normalizedTransaction.creditorName).toEqual('DIRECT DEBIT PAYMENT');
            expect(normalizedTransaction.debtorName).toEqual('DIRECT DEBIT PAYMENT');
            expect(normalizedTransaction.remittanceInformationUnstructured).toEqual('DIRECT DEBIT PAYMENT');
        });
        it('formats bank transfer payee and references', () => {
            ...
            expect(normalizedTransaction.remittanceInformationUnstructured).toEqual('Food');
        });
        it('removes method information from payee name', () => {
            ...
            expect(normalizedTransaction.remittanceInformationUnstructured).toEqual('Card 99, Tesco Express');
        });
    });
});
